...
abstract class Repository {
  ...
  Future<Either<Failure, dynamic>> getRecipesBasedOnCookBookId({required String cookBookId});
}
...
class RepositoryImp implements Repository {
  ...
  @override
  Future<Either<Failure, dynamic>> getRecipesBasedOnCookBookId({required String cookBookId}) async {
