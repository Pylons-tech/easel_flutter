...
class _$NftDao extends NftDao {
  ...
  @override
  Future<void> insertNft(NFT drafts) async {
    await _nFTInsertionAdapter.insert(drafts, OnConflictStrategy.abort);
  }
}
